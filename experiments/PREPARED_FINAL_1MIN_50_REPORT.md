...
`aethernetio` was **not** completed for this run. After chirkov finished, the
campaign was paused per operator request. A partial aethernetio flash/PPK
(~700 s, incomplete RX) was aborted and **discarded**; only chirkov numbers
